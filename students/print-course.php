...
$page_title = "FPE Portal - Course Form";
...
<div class="blank">
	<div class="blank-pages">
        <h3 class="page-header">Print Course Form</h3>

        <?php flash();?>

        <form action="print_cf.php" method="get" target="_blank">
            <div class="form-group">
                ...
                <select name="session" required class="form-control">
                    ...
                    <?php
                        $matric = user('matric');
                        $s = $db->query("SELECT DISTINCT(session) AS s FROM course_reg WHERE matric = '$matric'");
